...
describe("card script registry", () => {
  ...
  it("ships only explicitly implemented production card scripts", () => {
    ...
    expect(ENGINE_CARD_COVERAGE[POT_OF_GREED_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[BOOK_OF_MOON_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[MIRROR_FORCE_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[SAKURETSU_ARMOR_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[DEKOICHI_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[MAGICIAN_OF_FAITH_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[OLD_VINDICTIVE_MAGICIAN_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[EXILED_FORCE_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[BREAKER_THE_MAGICAL_WARRIOR_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[TRIBE_INFECTING_VIRUS_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[SINISTER_SERPENT_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[DD_WARRIOR_LADY_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[INJECTION_FAIRY_LILY_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[REFLECT_BOUNDER_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[JINZO_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[RING_OF_DESTRUCTION_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[CALL_OF_THE_HAUNTED_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[PREMATURE_BURIAL_ID]).toBe("implemented");
    expect(ENGINE_CARD_COVERAGE[SNATCH_STEAL_ID]).toBe("implemented");
